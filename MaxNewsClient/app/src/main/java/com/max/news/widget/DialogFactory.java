...
public class DialogFactory {
    ...
    /**
     * 这个方法很重要，是恢复dialog listener的一个关键点，在初始化DialogFactory或把DialogFactory
     * 赋值后，调用该方法，把调用该方法所在的类的实例作为参数。 该方法会把param中的属性依次遍历，
     * 尝试找属性是BaseDialogFragment.BaseDialogListener的实例，并且该属性就是保存在bundle中的
     * dialog listener key对应的dialog listener
     *
     * @param o 传入的对象
     */
...
//    }
     ...
     *
     * @param title      对话框 title
     * @param message    对话框 message
     * @param cancelable 对话框是否点击外部消失
     * @param listener   对话框监听
     */
    public void showConfirmDialog(String title, String message, boolean cancelable,
